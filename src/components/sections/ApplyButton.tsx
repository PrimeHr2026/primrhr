...
export function ApplyButton({ serviceName }: { serviceName: string }) {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-[70] flex items-end justify-center bg-navy-deep/80 p-0 backdrop-blur-sm sm:items-center sm:p-4" onClick={close}>
          <div
            className="max-h-[92vh] w-full max-w-lg overflow-y-auto rounded-t-3xl bg-white p-7 shadow-2xl sm:rounded-3xl sm:p-8"
              ...
              <form onSubmit={onSubmit} className="mt-6 space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <select name="format" className="h-11 w-full rounded-xl border border-mist bg-pearl px-3 text-sm outline-none focus:border-navy focus:bg-white">
                ...
                <div>
                  ...
                  <textarea name="message" rows={3} placeholder="Goals, topics, team background…" className="w-full rounded-xl border border-mist bg-pearl px-4 py-3 text-sm outline-none focus:border-navy focus:bg-white" />
                </div>
  ...
  return (
    <div>
      ...
      <input
        ...
        type={type}
        required={required}
        className="h-11 w-full rounded-xl border border-mist bg-pearl px-4 text-sm outline-none focus:border-navy focus:bg-white"
      />
    </div>
  );
}
